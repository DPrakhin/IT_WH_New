...
urlpatterns = [
    ...
    re_path(r'^accounts/update/(?P<data_employee_id>[0-9]+)$', user_update),
    re_path(r'^accounts/details/(?P<data_employee_id>[0-9]+)$', user_details),
    re_path(r'^accounts/delete/(?P<data_employee_id>[0-9]+)$', user_delete),
